...
namespace CSharpSoChiTieu.Business.Services
{
    public interface IIncomeExpenseHandler
    {
        ...
        Task<OperationResult> Gets(int page, int pageSize, string searchValue,/* IncomeExpenseType type = 0, string range = "month",*/ int? year = null, int? month = null, int? day = null);
        ...
        Task<OperationResult> GetSummary(int? year, int? month, int? day, string searchValue);
    }
}
